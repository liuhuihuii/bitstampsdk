...
class Client_Bitstamp():	#创建一个bitstamp所有服务的类
	...
	def _http_post(self,url,data):
		...
		try:
			...
			resp = None
			#print('Failed to create order with',type(e).__name__, str(e))
		return resp
...
#print(clien_bitstamp._get_depth())
#print(clien_bitstamp._open_orders(symbol='btcusd'))
print(clien_bitstamp._trade('market_buy',100.0,price=None,symbol='btc_usd'))
print(clien_bitstamp._trade('limit_buy',100.0,6500,symbol='btc_usd'))
